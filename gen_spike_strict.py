...
workdir = "/ocean/projects/med220004p/bshresth/vannucci/all_runs/scripts/outputs/old_outputs/ANTS_FSL_noBBR_strict/working/pipeline_cpac_fmriprep-options/"           
...
def run(args):
    ...
    if os.path.exists(fdj):
        ...
        threshold_df = (fdj_df > 0.2).astype(int)
        ...
        new_path_qc = os.path.join(os.getcwd(), 'TSVs_strict', 'qc')
        ...
        qc_df.to_csv(new_file_path_qc, header=['FD_J', 'thresholded_at_0.2', 'inverted'], index=False, sep='\t')
